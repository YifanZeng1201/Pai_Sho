...
public class Board
{
    ...
    public Board copy2()
    {
        ...
        Tile newT = new Tile(3, 1, "R");
        Space newS = new Space(NEUT, 0, 0);
        foreach (Space spot in this.occupied)
        {
            newT.mobility = spot.currentTile.mobility;
            newT.owner = spot.currentTile.owner;
            newT.color = spot.currentTile.color;
            newS.type = spot.type;
            newS.i = spot.i;
            newS.j = spot.j;
            newS.currentTile = spot.currentTile;
            newB.game_board[spot.i][spot.j] = spot;
        }
        return newB;
    }
    public Board copy()
